...
| 03 | Rebuild README | Rewrite README as install + quickstart + command table + config + docs index, and write the index | REQ-01, REQ-02, REQ-03, REQ-04, SC-01, SC-04 | planned |
