...
- **asked**: {what the human was asked, specifically — not "approved change"}
- **answered**: {what they actually said, including a refusal or a modification}
- **by**: {Name <email>}
- **at**: {sha} · {phase NN / plan NN-MM / PR #N, when scoped}
