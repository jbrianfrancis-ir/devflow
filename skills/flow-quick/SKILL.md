...
Deviation rules, commit discipline, package-install caution, and `.planning/ARCHITECTURE.md` constraints apply exactly as in normal execution (the executor owns them; in the trivial path, you do).
